...
var ReactHtml5Video = (function (_super) {
    __extends(ReactHtml5Video, _super);
    function ReactHtml5Video() {
    ...
    ReactHtml5Video.prototype.componentDidMount = function () {
        this.events();
    ...
    ReactHtml5Video.prototype.componentWillUnmount = function () {
    ...
    ReactHtml5Video.prototype.events = function () {
        var _this = this;
        if (this.player) {
    ...
    ReactHtml5Video.prototype.controlsHider = function () {
        var _this = this;
        this.setState({
            hideControls: false
        });
    ...
    ReactHtml5Video.prototype.drawAdv = function () {
    ...
    ReactHtml5Video.prototype.drawSlider = function () {
    ...
    ReactHtml5Video.prototype.setSource = function (play) {
    ...
    ReactHtml5Video.prototype.play = function () {
        var _this = this;
        this.player.play();
        this.setState({
            adv: false,
    ...
    ReactHtml5Video.prototype.pause = function (adv) {
        this.player.pause();
    ...
    ReactHtml5Video.prototype.getVideoTypeByEnum = function (type) {
        return this.videoTypes[type];
    };
    ReactHtml5Video.prototype.cancelFullscreen = function () {
    ...
    ReactHtml5Video.prototype.drawLoading = function () {
        if (this.state.loading) {
            return (React.createElement("div", { className: "ui-video-player-loading" }));
        }
    };
    ReactHtml5Video.prototype.drawStalled = function () {
    ...
    ReactHtml5Video.prototype.drawPlayStopSplash = function () {
    ...
    ReactHtml5Video.prototype.drawQuality = function () {
        var _this = this;
    ...
    ReactHtml5Video.prototype.getControls = function () {
    ...
    ReactHtml5Video.prototype.render = function () {
        var _this = this;
    ...
    return ReactHtml5Video;
}(React.Component));
ReactHtml5Video.defaultProps = {
    controls: true,
    enableSlider: false,
    enableAdv: true,
    hideSliderInMobile: true
};
exports.ReactHtml5Video = ReactHtml5Video;

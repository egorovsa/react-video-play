...
var UIVideoControlsComponent = (function (_super) {
    ...
    UIVideoControlsComponent.prototype.drawSeekBar = function () {
        return (React.createElement(react_video_seek_slider_1.VideoSeekSlider, { max: this.props.duration, currentTime: this.props.currentTime, progress: this.props.progressEnd, onChange: this.handlerChangeSeekBar }));
    };

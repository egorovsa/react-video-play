...
(function (VideoSourceType) {
    ...
    VideoSourceType[VideoSourceType["videi_ogg"] = 2] = "videi_ogg";
})(VideoSourceType = exports.VideoSourceType || (exports.VideoSourceType = {}));
var UIVideoComponent = (function (_super) {
    __extends(UIVideoComponent, _super);
    ...
    UIVideoComponent.prototype.componentDidMount = function () {
        this.events();
    ...
    UIVideoComponent.prototype.componentWillUnmount = function () {
    ...
    UIVideoComponent.prototype.events = function () {
        var _this = this;
        if (this.player) {
    ...
    UIVideoComponent.prototype.controlsHider = function () {
        var _this = this;
        this.setState({
            hideControls: false
        });
    ...
    UIVideoComponent.prototype.drawAdv = function () {
    ...
    UIVideoComponent.prototype.drawSlider = function () {
        if (this.props.showSlider && !(mobile() && this.props.hideSliderInMobile)) {
            return (React.createElement(UIVideoSliderComponent_1.UIVideoSlider, { show: this.state.adv }));
        }
    };
    UIVideoComponent.prototype.setSource = function (play) {
    ...
    UIVideoComponent.prototype.play = function () {
        var _this = this;
        this.player.play();
        this.setState({
            adv: false,
    ...
    UIVideoComponent.prototype.pause = function (adv) {
        this.player.pause();
    ...
    UIVideoComponent.prototype.getVideoTypeByEnum = function (type) {
        return this.videoTypes[type];
    };
    UIVideoComponent.prototype.cancelFullscreen = function () {
    ...
    UIVideoComponent.prototype.drawLoading = function () {
        if (this.state.loading) {
            return (React.createElement("div", { className: "ui-video-player-loading" }));
        }
    };
    UIVideoComponent.prototype.drawStalled = function () {
    ...
    UIVideoComponent.prototype.drawPlayStopSplash = function () {
    ...
    UIVideoComponent.prototype.drawQuality = function () {
        var _this = this;
    ...
    UIVideoComponent.prototype.render = function () {
        ...
        return (React.createElement("div", { tabIndex: 0, className: className, style: {
            ...
            React.createElement("video", { width: "100%", height: this.props.height ? this.props.height : '', ref: function (player) {
                    _this.player = player;
                }, onClick: this.handlerVideoClick, poster: this.props.poster })));
    };
    return UIVideoComponent;
}(React.Component));
UIVideoComponent.defaultProps = {
    controls: true,
    showSlider: true,
    showAdv: true,
    hideSliderInMobile: true
};
exports.UIVideoComponent = UIVideoComponent;
